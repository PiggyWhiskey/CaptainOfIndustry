...
// Type: Mafi.Base.Prototypes.Machines.PowerGenerators.ElectricityGeneratorFromMechPowerResolver
...
namespace Mafi.Base.Prototypes.Machines.PowerGenerators
{
  ...
  internal class ElectricityGeneratorFromMechPowerResolver : 
    PortProductResolverBase<ElectricityGeneratorFromMechPower>
  {
    private readonly ImmutableArray<ProductProto> m_mechanicalPower;

    public ElectricityGeneratorFromMechPowerResolver(ProtosDb protosDb)
    {
    ...
    protected override ImmutableArray<ProductProto> GetPortProduct(
      ElectricityGeneratorFromMechPower entity,
      IoPort port,
