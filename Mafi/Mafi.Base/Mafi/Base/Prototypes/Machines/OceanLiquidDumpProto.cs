...
// Type: Mafi.Base.Prototypes.Machines.OceanLiquidDumpProto
...
{
  public class OceanLiquidDumpProto : 
    MachineProto,
    ...
    IProto
  {
    public override Type EntityType => typeof (OceanLiquidDump);
