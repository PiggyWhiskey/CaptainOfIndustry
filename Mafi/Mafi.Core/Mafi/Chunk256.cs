...
namespace Mafi
{
  ...
  [DebuggerDisplay("({X}, {Y})")]
  [DebuggerStepThrough]
  public struct Chunk256 : IEquatable<Chunk256>, IComparable<Chunk256>
  {
    public const int DIMENSION_TILES = 256;
    public const int DIMENSION_TILES_BITS = 8;
    /// <summary>Vector (0, 0).</summary>
    public static readonly Chunk256 Zero;
    /// <summary>Vector (1, 1).</summary>
    public static readonly Chunk256 One;
    /// <summary>Vector (1, 0).</summary>
    public static readonly Chunk256 UnitX;
    /// <summary>Vector (0, 1).</summary>
    public static readonly Chunk256 UnitY;
    /// <summary>Vector (byte.MinValue, byte.MinValue).</summary>
    public static readonly Chunk256 MinValue;
    /// <summary>Vector (byte.MaxValue, byte.MaxValue).</summary>
    public static readonly Chunk256 MaxValue;
    /// <summary>The X component of this vector.</summary>
    public readonly byte X;
    /// <summary>The Y component of this vector.</summary>
    public readonly byte Y;

    public Tile2i OriginTile2i => new Tile2i((int) this.X << 8, (int) this.Y << 8);

    /// <summary>Creates new Chunk256 from raw components.</summary>
    public Chunk256(byte x, byte y)
    {
    ...
    /// PERF: Expensive, uses sqrt. Consider using <see cref="P:Mafi.Chunk256.LengthSqr" /> whenever possible (when comparing
    /// lengths, etc.).
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    /// PERF: Expensive, uses sqrt, consider using <see cref="P:Mafi.Chunk256.LengthSqr" /> whenever possible.
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    /// PERF: Cheaper than <see cref="P:Mafi.Chunk256.Length" />, does not require expensive sqrt.
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public bool IsZero => this.X == (byte) 0 && this.Y == (byte) 0;

    /// <summary>e
    /// Whether this vector has at least one components not equal to zero.
    /// </summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public bool IsNotZero => this.X != (byte) 0 || this.Y > (byte) 0;

    /// <summary>Returns new vector with changed X component.</summary>
    [Pure]
    public Chunk256 SetX(byte newX) => new Chunk256(newX, this.Y);

    /// <summary>Returns new vector with changed Y component.</summary>
    [Pure]
    public Chunk256 SetY(byte newY) => new Chunk256(this.X, newY);

    /// <summary>Returns new vector with incremented X component.</summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public Chunk256 IncrementX => new Chunk256((byte) ((uint) this.X + 1U), this.Y);

    /// <summary>Returns new vector with incremented Y component.</summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public Chunk256 IncrementY => new Chunk256(this.X, (byte) ((uint) this.Y + 1U));

    /// <summary>Returns new vector with decremented X component.</summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public Chunk256 DecrementX => new Chunk256((byte) ((uint) this.X - 1U), this.Y);

    /// <summary>Returns new vector with decremented Y component.</summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public Chunk256 DecrementY => new Chunk256(this.X, (byte) ((uint) this.Y - 1U));

    /// <summary>
    /// Returns new vector with given value added to the X component.
    /// </summary>
    [Pure]
    public Chunk256 AddX(int addedX)
    {
      return new Chunk256((byte) ((uint) this.X + (uint) addedX), this.Y);
    }
    ...
    /// </summary>
    [Pure]
    public Chunk256 AddY(int addedY)
    {
      return new Chunk256(this.X, (byte) ((uint) this.Y + (uint) addedY));
    }
    ...
    /// </summary>
    [Pure]
    public Chunk256 AddXy(int addedValue)
    {
      return new Chunk256((byte) ((uint) this.X + (uint) addedValue), (byte) ((uint) this.Y + (uint) addedValue));
    }
    ...
    /// </summary>
    [Pure]
    public Chunk256 MultiplyX(int multX)
    {
      return new Chunk256((byte) ((uint) this.X * (uint) multX), this.Y);
    }
    ...
    /// </summary>
    [Pure]
    public Chunk256 MultiplyY(int multY)
    {
      return new Chunk256(this.X, (byte) ((uint) this.Y * (uint) multY));
    }
    ...
    /// </summary>
    [Pure]
    public bool IsNear(Chunk256 other, byte tolerance)
    {
    ...
    [Pure]
    public int Dot(Chunk256 rhs) => (int) this.X * (int) rhs.X + (int) this.Y * (int) rhs.Y;
    ...
    /// </summary>
    [Pure]
    public int DotInt(Chunk256 rhs) => (int) this.X * (int) rhs.X + (int) this.Y * (int) rhs.Y;

    /// <summary>
    /// Returns distance from this vector to the other vector.
    /// </summary>
    [Pure]
    public Fix32 DistanceTo(Chunk256 other)
    {
    ...
    /// </summary>
    [Pure]
    public int DistanceSqrTo(Chunk256 other)
    {
    ...
    /// </remarks>
    [Pure]
    public int PseudoCross(Chunk256 other)
    {
    ...
    /// </summary>
    [Pure]
    public AngleDegrees1f AngleTo(Chunk256 other)
    {
      Assert.That<Chunk256>(this).IsNotZero("AngleTo was called on zero vector.");
      Assert.That<Chunk256>(other).IsNotZero("AngleTo was called with zero vector.");
    ...
    /// </summary>
    [Pure]
    public AngleDegrees1f AngleBetween(Chunk256 other) => this.AngleTo(other).Abs;

    /// <summary>
    /// Whether this and <see paramref="other" /> vectors are parallel and not anti-parallel.
    /// </summary>
    [Pure]
    public bool IsParallelTo(Chunk256 other)
    {
      Assert.That<Chunk256>(this).IsNotZero("IsParallelTo was called on zero vector.");
      Assert.That<Chunk256>(other).IsNotZero("IsParallelTo was called with zero vector.");
    ...
    /// </summary>
    [Pure]
    public bool IsAntiParallelTo(Chunk256 other)
    {
      Assert.That<Chunk256>(this).IsNotZero("IsParallelTo was called on zero vector.");
      Assert.That<Chunk256>(other).IsNotZero("IsParallelTo was called with zero vector.");
      return this.PseudoCross(other) == 0 && this.Dot(other) < 0;
    ...
    /// </summary>
    [Pure]
    public bool IsParallelOrAntiParallelTo(Chunk256 other)
    {
      Assert.That<Chunk256>(this).IsNotZero("IsParallelTo was called on zero vector.");
      Assert.That<Chunk256>(other).IsNotZero("IsParallelTo was called with zero vector.");
    ...
    [Pure]
    public Chunk256 Min(Chunk256 rhs) => new Chunk256(this.X.Min(rhs.X), this.Y.Min(rhs.Y));

    /// <summary>Returns component-wise min of this and given vectors.</summary>
    [Pure]
    public Chunk256 Max(Chunk256 rhs) => new Chunk256(this.X.Max(rhs.X), this.Y.Max(rhs.Y));
    ...
    [Pure]
    public Chunk256 Clamp(byte min, byte max)
    {
      return new Chunk256(this.X.Clamp(min, max), this.Y.Clamp(min, max));
    }

    [Pure]
    public bool Equals(Chunk256 other) => other == this;

    [Pure]
    public override bool Equals(object other) => other is Chunk256 chunk256 && chunk256 == this;
    ...
    [Pure]
    public int CompareTo(Chunk256 other)
    {
    ...
    public static bool operator ==(Chunk256 lhs, Chunk256 rhs)
    {
    ...
    public static Chunk256 operator +(int lhs, Chunk256 rhs)
    {
      return new Chunk256((byte) ((uint) lhs + (uint) rhs.X), (byte) ((uint) lhs + (uint) rhs.Y));
    }

    public static Chunk256 operator +(Chunk256 lhs, int rhs)
    {
      return new Chunk256((byte) ((uint) lhs.X + (uint) rhs), (byte) ((uint) lhs.Y + (uint) rhs));
    }
    ...
    public static void Serialize(Chunk256 value, BlobWriter writer)
    {
      writer.WriteByte(value.X);
      writer.WriteByte(value.Y);
    }

    public static Chunk256 Deserialize(BlobReader reader)
    {
      return new Chunk256(reader.ReadByte(), reader.ReadByte());
    }

    static Chunk256()
    {
      MBiHIp97M4MqqbtZOh.rMWAw2OR8();
      Chunk256.Zero = new Chunk256();
      Chunk256.One = new Chunk256((byte) 1, (byte) 1);
      Chunk256.UnitX = new Chunk256((byte) 1, (byte) 0);
      Chunk256.UnitY = new Chunk256((byte) 0, (byte) 1);
      Chunk256.MinValue = new Chunk256((byte) 0, (byte) 0);
      Chunk256.MaxValue = new Chunk256(byte.MaxValue, byte.MaxValue);
    }
  }
}
