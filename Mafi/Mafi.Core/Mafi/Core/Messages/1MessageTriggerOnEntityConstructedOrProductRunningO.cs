...
// Type: Mafi.Core.Messages.MessageTriggerOnEntityConstructedOrProductRunningOutProto
...
{
  public class MessageTriggerOnEntityConstructedOrProductRunningOutProto : MessageTriggerProto
  {
    ...
    {
      get => typeof (MessageTriggerOnEntityConstructedOrProductRunningOut);
    }

    public MessageTriggerOnEntityConstructedOrProductRunningOutProto(
