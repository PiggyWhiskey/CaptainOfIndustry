...
// Type: Mafi.Core.Entities.Blueprints.BlueprintsFolder
...
namespace Mafi.Core.Entities.Blueprints
{
  internal class BlueprintsFolder : IBlueprintsFolder, IBlueprintItem, IBlueprintItemFriend
  {
    ...
    public BlueprintsFolder(string name)
    {
      ...
      this.\u003CPreviewProtos\u003Ek__BackingField = new Lyst<Proto>();
      ...
      Lyst<IBlueprint> blueprints)
    {
      ...
      foreach (BlueprintsFolder folder in folders)
        folder.ParentFolder = (Option<IBlueprintsFolder>) (IBlueprintsFolder) this;
    ...
    internal bool TryAdd(IBlueprintsFolder newFolder)
    {
      ...
      ((BlueprintsFolder) newFolder).SetParentFolder((Option<IBlueprintsFolder>) (IBlueprintsFolder) this);
      return true;
    }
...
label_4:
    ...
    public IBlueprintsFolder CreateCopyForSave()
    {
      return (IBlueprintsFolder) new BlueprintsFolder(this.Name, this.Desc, ((IEnumerable<IBlueprintsFolder>) this.m_folders.Select<IBlueprintsFolder>((Func<IBlueprintsFolder, IBlueprintsFolder>) (x => ((BlueprintsFolder) x).CreateCopyForSave()))).ToLyst<IBlueprintsFolder>(), ((IEnumerable<IBlueprint>) this.m_blueprints.Select<IBlueprint>((Func<IBlueprint, IBlueprint>) (x => ((Blueprint) x).CreateCopyForSave()))).ToLyst<IBlueprint>());
    }
      ...
      int libraryVersion)
    {
      ...
      {
        BlueprintsFolder blueprintsFolder = BlueprintsFolder.DeserializeForBlueprints(reader, context, libraryVersion);
