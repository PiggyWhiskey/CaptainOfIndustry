...
// Type: Mafi.Core.Entities.Static.Layout.Upgrade.ILayoutEntityUpgraderFactory
...
{
  public interface ILayoutEntityUpgraderFactory
  {
    EntityId.Factory EntityIdFactory { get; }

    IUpgrader CreateInstance<TProto, TEntity>(TEntity entity, TProto entityProto)
