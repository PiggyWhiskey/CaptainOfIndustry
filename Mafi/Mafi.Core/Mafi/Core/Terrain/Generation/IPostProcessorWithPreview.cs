...
// Type: Mafi.Core.Terrain.Generation.IPostProcessorWithPreview
...
{
  public interface IPostProcessorWithPreview : IEditableTerrainFeature, ITerrainFeatureBase
  {
    /// <summary>
    ...
    bool TryGetPreviewsWithContextFromPrevious(
      IResolver resolver,
      IIndexable<ITerrainPostProcessorV2> terrainPostProcessors,
      int timeBudgetMs,
      out IEnumerable<ITerrainFeaturePreview> previews);

    void GenerateChunkPreview(IResolver resolver, ITerrainFeaturePreview chunkData, bool final);
  }
}
