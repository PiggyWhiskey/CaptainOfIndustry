...
// Type: Mafi.Core.Population.Edicts.PopsGrowthPauseEdictProto
...
{
  /// <summary>Edict that pauses population growth.</summary>
  public class PopsGrowthPauseEdictProto : EdictProto
  {
    public PopsGrowthPauseEdictProto(
      Proto.ID id,
      Proto.Str strings,
