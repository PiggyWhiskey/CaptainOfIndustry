  ...
  internal class OBqe2IUAeSpOmlOQ4O
  {
    ...
    internal static void cQqa7Eegfx()
    {
      if (OBqe2IUAeSpOmlOQ4O.oLdaoiVT7G != null)
        return;
      BinaryReader binaryReader = new BinaryReader(typeof (OBqe2IUAeSpOmlOQ4O).Assembly.GetManifestResourceStream("uNrsWsx7h5I88kH9Fx.WtkCkouTDQIQbAYUI3"));
...
label_424:
    ...
    private struct d8DC6491120AB76E
    {
      private StringBuilder sb;

      public d8DC6491120AB76E(int _param1, int _param2)
      {
        MBiHIp97M4MqqbtZOh.rMWAw2OR8();
        this.sb = new StringBuilder();
      }

      public d8DC6491120AB76E(int _param1, int _param2, IFormatProvider _param3)
      {
        MBiHIp97M4MqqbtZOh.rMWAw2OR8();
        this.sb = new StringBuilder();
      }
