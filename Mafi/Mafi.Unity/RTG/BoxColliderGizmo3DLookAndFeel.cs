...
// Type: RTG.BoxColliderGizmo3DLookAndFeel
...
namespace RTG
{
  ...
  public class BoxColliderGizmo3DLookAndFeel
  {
    ...
    public static Color DefaultMidCapColor
    {
      get => ColorEx.FromByteValues((byte) 153, (byte) 232, (byte) 144, byte.MaxValue);
    }

    public static Color DefaultMidCapHoveredColor => RTSystemValues.HoveredAxisColor;

    public static GizmoFillMode3D DefaultMidCapFillMode => GizmoFillMode3D.Filled;

    public static GizmoCap3DType DefaultMidCapType => GizmoCap3DType.Box;

    public static bool DefaultMidCapVisible => true;

    public static float DefaultMidCapBoxWidth => 0.7f;

    public static float DefaultMidCapBoxHeight => 0.7f;

    public static float DefaultMidCapBoxDepth => 0.7f;
    ...
    public Color MidCapHoveredColor => this._midCapLookAndFeel.HoveredColor;
    ...
    public BoxColliderGizmo3DLookAndFeel()
    {
      ...
      this._wireColor = BoxColliderGizmo3DLookAndFeel.DefaultWireColor;
      this._tickLookAndFeel = new GizmoCap2DLookAndFeel[6];
      this._midCapLookAndFeel = new GizmoCap3DLookAndFeel();
      this._isMidCapVisible = BoxColliderGizmo3DLookAndFeel.DefaultMidCapVisible;
      this._tickCullAlphaScale = BoxColliderGizmo3DLookAndFeel.DefaultTickCullAlphaScale;
      // ISSUE: explicit constructor call
      base.\u002Ector();
      for (int index = 0; index < this._tickLookAndFeel.Length; ++index)
        this._tickLookAndFeel[index] = new GizmoCap2DLookAndFeel();
      this.SetTickColor(0, BoxColliderGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickColor(1, BoxColliderGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickColor(2, BoxColliderGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickHoveredColor(BoxColliderGizmo3DLookAndFeel.DefaultTickHoveredColor);
      this.SetTickBorderColor(BoxColliderGizmo3DLookAndFeel.DefaultTickBorderColor);
      this.SetTickHoveredBorderColor(BoxColliderGizmo3DLookAndFeel.DefaultTickHoveredBorderColor);
      this.SetTickQuadWidth(BoxColliderGizmo3DLookAndFeel.DefaultTickQuadWidth);
      this.SetTickQuadHeight(BoxColliderGizmo3DLookAndFeel.DefaultTickQuadHeight);
      this.SetTickCircleRadius(BoxColliderGizmo3DLookAndFeel.DefaultTickCircleRadius);
      this.SetTickType(BoxColliderGizmo3DLookAndFeel.DefaultTickCapType);
      this.SetMidCapColor(BoxColliderGizmo3DLookAndFeel.DefaultMidCapColor);
      this.SetMidCapHoveredColor(BoxColliderGizmo3DLookAndFeel.DefaultMidCapHoveredColor);
      this.SetMidCapFillMode(BoxColliderGizmo3DLookAndFeel.DefaultMidCapFillMode);
      this.SetMidCapType(BoxColliderGizmo3DLookAndFeel.DefaultMidCapType);
      this.SetMidCapVisible(BoxColliderGizmo3DLookAndFeel.DefaultMidCapVisible);
      this.SetMidCapBoxWidth(BoxColliderGizmo3DLookAndFeel.DefaultMidCapBoxWidth);
      this.SetMidCapBoxHeight(BoxColliderGizmo3DLookAndFeel.DefaultMidCapBoxHeight);
      this.SetMidCapBoxDepth(BoxColliderGizmo3DLookAndFeel.DefaultMidCapBoxDepth);
    }
    ...
    public void SetMidCapHoveredColor(Color color) => this._midCapLookAndFeel.HoveredColor = color;
    ...
    public void SetBoxWireColor(Color color) => this._wireColor = color;
