...
// Type: RTG.CapsuleColliderGizmo3DLookAndFeel
...
namespace RTG
{
  ...
  public class CapsuleColliderGizmo3DLookAndFeel
  {
    ...
    public CapsuleColliderGizmo3DLookAndFeel()
    {
      ...
      this._wireColor = CapsuleColliderGizmo3DLookAndFeel.DefaultWireColor;
      this._tickLookAndFeel = new GizmoCap2DLookAndFeel[6];
      this._tickCullAlphaScale = CapsuleColliderGizmo3DLookAndFeel.DefaultTickCullAlphaScale;
      // ISSUE: explicit constructor call
      base.\u002Ector();
      for (int index = 0; index < this._tickLookAndFeel.Length; ++index)
        this._tickLookAndFeel[index] = new GizmoCap2DLookAndFeel();
      this.SetTickColor(0, CapsuleColliderGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickColor(1, CapsuleColliderGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickColor(2, CapsuleColliderGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickHoveredColor(CapsuleColliderGizmo3DLookAndFeel.DefaultTickHoveredColor);
      this.SetTickBorderColor(CapsuleColliderGizmo3DLookAndFeel.DefaultTickBorderColor);
      this.SetTickHoveredBorderColor(CapsuleColliderGizmo3DLookAndFeel.DefaultTickHoveredBorderColor);
      this.SetTickQuadWidth(CapsuleColliderGizmo3DLookAndFeel.DefaultTickQuadWidth);
      this.SetTickQuadHeight(CapsuleColliderGizmo3DLookAndFeel.DefaultTickQuadHeight);
      this.SetTickCircleRadius(CapsuleColliderGizmo3DLookAndFeel.DefaultTickCircleRadius);
      this.SetTickType(CapsuleColliderGizmo3DLookAndFeel.DefaultTickCapType);
    }
