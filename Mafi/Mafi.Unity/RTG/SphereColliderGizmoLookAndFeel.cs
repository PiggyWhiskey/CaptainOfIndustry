...
// Type: RTG.SphereColliderGizmoLookAndFeel
...
namespace RTG
{
  ...
  public class SphereColliderGizmoLookAndFeel
  {
    ...
    public static Color DefaultSphereBorderColor
    {
    ...
    public static float DefaultAxialCircleCullAlphaScale => 0.3f;
    ...
    public Color SphereBorderColor => this._sphereBorderColor;

    public Color WireColor => this._wireColor;

    public float AxialCircleCullAlphaScale => this._axialCircleCullAlphaScale;
    ...
    public SphereColliderGizmoLookAndFeel()
    {
      ...
      this._sphereBorderColor = SphereColliderGizmoLookAndFeel.DefaultSphereBorderColor;
      this._tickLookAndFeel = new GizmoCap2DLookAndFeel[6];
      this._wireColor = SphereColliderGizmoLookAndFeel.DefaultWireColor;
      this._axialCircleCullAlphaScale = SphereColliderGizmoLookAndFeel.DefaultAxialCircleCullAlphaScale;
      this._tickCullAlphaScale = SphereColliderGizmoLookAndFeel.DefaultTickCullAlphaScale;
      // ISSUE: explicit constructor call
      base.\u002Ector();
      for (int index = 0; index < this._tickLookAndFeel.Length; ++index)
        this._tickLookAndFeel[index] = new GizmoCap2DLookAndFeel();
      this.SetSphereBorderColor(SphereColliderGizmoLookAndFeel.DefaultSphereBorderColor);
      this.SetWireColor(SphereColliderGizmoLookAndFeel.DefaultWireColor);
      this.SetTickColor(0, SphereColliderGizmoLookAndFeel.DefaultTickColor);
      this.SetTickColor(1, SphereColliderGizmoLookAndFeel.DefaultTickColor);
      this.SetTickColor(2, SphereColliderGizmoLookAndFeel.DefaultTickColor);
      this.SetTickHoveredColor(SphereColliderGizmoLookAndFeel.DefaultTickHoveredColor);
      this.SetTickBorderColor(SphereColliderGizmoLookAndFeel.DefaultTickBorderColor);
      this.SetTickHoveredBorderColor(SphereColliderGizmoLookAndFeel.DefaultTickHoveredBorderColor);
      this.SetTickQuadWidth(SphereColliderGizmoLookAndFeel.DefaultTickQuadWidth);
      this.SetTickQuadHeight(SphereColliderGizmoLookAndFeel.DefaultTickQuadHeight);
      this.SetTickCircleRadius(SphereColliderGizmoLookAndFeel.DefaultTickCircleRadius);
      this.SetTickType(SphereColliderGizmoLookAndFeel.DefaultTickCapType);
    }
    ...
    public void SetSphereBorderColor(Color color) => this._sphereBorderColor = color;

    public void SetWireColor(Color color) => this._wireColor = color;

    public void SetAxialCircleCullAlphaScale(float scale)
    {
      this._axialCircleCullAlphaScale = Mathf.Clamp(scale, 0.0f, 1f);
    }
