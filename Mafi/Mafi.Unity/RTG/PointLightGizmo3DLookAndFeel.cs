...
// Type: RTG.PointLightGizmo3DLookAndFeel
...
namespace RTG
{
  ...
  public class PointLightGizmo3DLookAndFeel
  {
    ...
    public PointLightGizmo3DLookAndFeel()
    {
      ...
      this._sphereBorderColor = PointLightGizmo3DLookAndFeel.DefaultSphereBorderColor;
      this._tickLookAndFeel = new GizmoCap2DLookAndFeel[6];
      this._wireColor = PointLightGizmo3DLookAndFeel.DefaultWireColor;
      this._axialCircleCullAlphaScale = PointLightGizmo3DLookAndFeel.DefaultAxialCircleCullAlphaScale;
      this._tickCullAlphaScale = PointLightGizmo3DLookAndFeel.DefaultTickCullAlphaScale;
      // ISSUE: explicit constructor call
      base.\u002Ector();
      for (int index = 0; index < this._tickLookAndFeel.Length; ++index)
        this._tickLookAndFeel[index] = new GizmoCap2DLookAndFeel();
      this.SetSphereBorderColor(PointLightGizmo3DLookAndFeel.DefaultSphereBorderColor);
      this.SetWireColor(PointLightGizmo3DLookAndFeel.DefaultWireColor);
      this.SetTickColor(0, PointLightGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickColor(1, PointLightGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickColor(2, PointLightGizmo3DLookAndFeel.DefaultTickColor);
      this.SetTickHoveredColor(PointLightGizmo3DLookAndFeel.DefaultTickHoveredColor);
      this.SetTickBorderColor(PointLightGizmo3DLookAndFeel.DefaultTickBorderColor);
      this.SetTickHoveredBorderColor(PointLightGizmo3DLookAndFeel.DefaultTickHoveredBorderColor);
      this.SetTickQuadWidth(PointLightGizmo3DLookAndFeel.DefaultTickQuadWidth);
      this.SetTickQuadHeight(PointLightGizmo3DLookAndFeel.DefaultTickQuadHeight);
      this.SetTickCircleRadius(PointLightGizmo3DLookAndFeel.DefaultTickCircleRadius);
      this.SetTickType(PointLightGizmo3DLookAndFeel.DefaultTickCapType);
    }
