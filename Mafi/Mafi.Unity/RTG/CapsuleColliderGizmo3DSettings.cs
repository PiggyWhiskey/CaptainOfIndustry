...
// Type: RTG.CapsuleColliderGizmo3DSettings
...
namespace RTG
{
  ...
  public class CapsuleColliderGizmo3DSettings
  {
    ...
    public CapsuleColliderGizmo3DSettings()
    {
      ...
      this._radiusSnapStep = CapsuleColliderGizmo3DSettings.DefaultRadiusSnapStep;
      this._heightSnapStep = CapsuleColliderGizmo3DSettings.DefaultHeightSnapStep;
