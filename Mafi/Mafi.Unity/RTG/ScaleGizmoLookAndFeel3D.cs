...
namespace RTG
{
  ...
  public class ScaleGizmoLookAndFeel3D : Settings
  {
    ...
    public float DblSliderSize => this._dblSlidersLookAndFeel[0].RATriangleXLength;
    ...
    public bool IsScaleGuideVisible => this._isScaleGuideVisible;

    public float ScaleGuideAxisLength => this._scaleGuideLookAndFeel.AxisLength;
    ...
    public ScaleGizmoLookAndFeel3D()
    {
      ...
      this._scaleGuideLookAndFeel = new GizmoScaleGuideLookAndFeel();
      this._isScaleGuideVisible = true;
      ...
      for (int index = 0; index < this._dblSlidersLookAndFeel.Length; ++index)
      {
        ...
        this._dblSlidersLookAndFeel[index].PlaneType = GizmoPlane3DType.RATriangle;
      }
      this.SetSliderCapType(GizmoCap3DType.Box);
      ...
      this.SetMidCapBoxWidth(0.9f);
      this.SetMidCapBoxHeight(0.9f);
      this.SetMidCapBoxDepth(0.9f);
      this.SetMidCapSphereRadius(0.65f);
      this.SetDblSliderFillAlpha(RTSystemValues.AxisAlpha);
      this.SetDblSliderSize(1.9f);
      this.SetDblSliderVisible(PlaneId.XY, true);
      this.SetDblSliderVisible(PlaneId.YZ, true);
      this.SetDblSliderVisible(PlaneId.ZX, true);
    }

    public void SetScaleGuideVisible(bool isVisible) => this._isScaleGuideVisible = isVisible;
    ...
    public void SetUseZoomFactor(bool useZoomFactor)
    {
      ...
      this._scaleGuideLookAndFeel.UseZoomFactor = useZoomFactor;
    }

    public void SetScaleGuideAxisLength(float length)
    {
      this._scaleGuideLookAndFeel.AxisLength = length;
    }
    ...
    public void SetAxisColor(int axisIndex, Color color)
    {
      ...
      switch (axisIndex)
      {
        case 0:
          ...
          this._scaleGuideLookAndFeel.XAxisColor = color;
          break;
        case 1:
          slider3DlookAndFeel = this.GetDblSliderLookAndFeel(PlaneId.ZX);
          this._scaleGuideLookAndFeel.YAxisColor = color;
          break;
        case 2:
          slider3DlookAndFeel = this.GetDblSliderLookAndFeel(PlaneId.XY);
          this._scaleGuideLookAndFeel.ZAxisColor = color;
          break;
      }
    ...
    {
      slider.SharedLookAndFeel = this.GetDblSliderLookAndFeel(planeId);
    }

    public void ConnectGizmoScaleGuideLookAndFeel(GizmoScaleGuide scaleGuide)
    {
      scaleGuide.SharedLookAndFeel = this._scaleGuideLookAndFeel;
    }
