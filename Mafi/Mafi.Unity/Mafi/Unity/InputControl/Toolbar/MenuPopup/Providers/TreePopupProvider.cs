...
// Type: Mafi.Unity.InputControl.Toolbar.MenuPopup.Providers.TreePopupProvider
...
namespace Mafi.Unity.InputControl.Toolbar.MenuPopup.Providers
{
  ...
  internal class TreePopupProvider : PopupProviderBase<TreeProto>
  {
    ...
    public TreePopupProvider(UnlockedProtosDbForUi unlockedProtosDb)
    {
    ...
    protected override void PopulateView(MenuPopupView view, TreeProto proto, bool isForResearch)
    {
