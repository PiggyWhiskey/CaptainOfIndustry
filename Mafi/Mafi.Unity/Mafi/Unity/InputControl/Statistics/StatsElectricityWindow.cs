...
// Type: Mafi.Unity.InputControl.Statistics.StatsElectricityWindow
...
namespace Mafi.Unity.InputControl.Statistics
{
  ...
  internal class StatsElectricityWindow : WindowView
  {
    private TabsContainer m_tabsContainer;
    private readonly ElectricityPerProtoChartTab m_perProtoChartTab;
    private readonly StatsElectricityTab m_chartTab;
    private readonly ElectricityBreakdownTab m_breakdownTab;

    internal StatsElectricityWindow(
      ElectricityPerProtoChartTab perProtoChartTab,
      StatsElectricityTab chartTab,
      ElectricityBreakdownTab breakdownTab)
    {
      xxhJUtQyC9HnIshc6H.OukgcisAbr();
      // ISSUE: explicit constructor call
      base.\u002Ector("ElectricityStats");
    ...
    {
      this.SetTitle((LocStrFormatted) Tr.ElectricityStats);
