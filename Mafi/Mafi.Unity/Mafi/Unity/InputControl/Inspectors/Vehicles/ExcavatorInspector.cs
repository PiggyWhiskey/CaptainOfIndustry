...
// Type: Mafi.Unity.InputControl.Inspectors.Vehicles.ExcavatorInspector
...
namespace Mafi.Unity.InputControl.Inspectors.Vehicles
{
  ...
  internal class ExcavatorInspector : VehicleInspector<Excavator, ExcavatorWindowView>
  {
    private readonly DependencyResolver m_resolver;

    public ExcavatorInspector(
    ...
    protected override ExcavatorWindowView GetView()
    {
      return this.m_resolver.Instantiate<ExcavatorWindowView>(new object[1]
      {
        (object) this
      });
    }
