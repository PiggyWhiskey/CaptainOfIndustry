...
// Type: Mafi.Unity.InputControl.Inspectors.Buildings.StorageInspector
...
namespace Mafi.Unity.InputControl.Inspectors.Buildings
{
  ...
  internal class StorageInspector : StorageInspectorGeneric<Storage>
  {
    public StorageInspector(
