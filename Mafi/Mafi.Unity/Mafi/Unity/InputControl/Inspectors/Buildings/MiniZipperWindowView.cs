...
// Type: Mafi.Unity.InputControl.Inspectors.Buildings.MiniZipperWindowView
...
{
  internal class MiniZipperWindowView : StaticEntityInspectorBase<MiniZipper>
  {
    private readonly MiniZipperInspector m_inspector;
    ...
    protected override MiniZipper Entity => this.m_inspector.SelectedEntity;

    public MiniZipperWindowView(MiniZipperInspector inspector)
    {
