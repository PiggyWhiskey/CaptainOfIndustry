...
// Type: Mafi.Unity.Mine.LevelTerrainDesignationController
...
namespace Mafi.Unity.Mine
{
  ...
  public class LevelTerrainDesignationController : TerrainDesignationController
  {
    public LevelTerrainDesignationController(
      ...
      UiBuilder builder)
    {
      ...
      base.\u002Ector(inputManager, terrainCursor, renderer, towerAreasRenderer, manager, shortcutsManager, (IAreaToolbox) new AreaToolbox(toolbarController, builder, messagesCenter, AreaToolbox.ToolType.Leveling), cursors, cursorMessage, toolbarController, gameLoopEvents, terrainOutlineRenderer, designationManager, unlockedProtosDb, protosDb.GetOrThrow<TerrainDesignationProto>(IdsCore.TerrainDesignators.LevelDesignator), cameraController, oceanOverlayRenderer, builder, builder.AudioDb.GetSharedAudioUi("Assets/Unity/UserInterface/Audio/FlattenApply.prefab"), protosDb.Get<Proto>(IdsCore.Technology.TerrainLeveling), false, true);
    }
    ...
    protected override void RegisterUiToolbar(
      ...
      ToolbarController toolbarController)
    {
      toolbarController.AddMainMenuButton(Tr.Designation__Leveling.TranslatedString, (IToolbarItemController) this, "Assets/Unity/UserInterface/Toolbar/Leveling128.png", 330f, (Func<ShortcutsManager, KeyBindings>) (m => m.ToggleLevelingTool));
    }
  }
}
