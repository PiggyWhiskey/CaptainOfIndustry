...
// Type: Mafi.Unity.Mine.SurfacePlacementToolbox
...
namespace Mafi.Unity.Mine
{
  ...
  internal class SurfacePlacementToolbox : Mafi.Unity.InputControl.Toolbar.Toolbox
  {
    ...
    public SurfacePlacementToolbox(
    ...
    {
      this.PrimaryActionBtn = this.AddToggleButton("AddDesignation", "Assets/Unity/UserInterface/Toolbar/Concrete128.png", (Action<bool>) (_ => { }), (Func<ShortcutsManager, KeyBindings>) (m => m.PrimaryAction));
