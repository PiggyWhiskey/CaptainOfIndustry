...
// Type: Mafi.Unity.Mine.DumpingDesignationController
...
namespace Mafi.Unity.Mine
{
  ...
  public class DumpingDesignationController : TerrainDesignationController
  {
    public DumpingDesignationController(
      ...
      UiBuilder builder)
    {
      ...
      base.\u002Ector(inputManager, terrainCursor, renderer, towerAreasRenderer, manager, shortcutsManager, (IAreaToolbox) new AreaToolbox(toolbarController, builder, messagesCenter, AreaToolbox.ToolType.Dumping), cursors, cursorMessage, toolbarController, gameLoopEvents, terrainOutlineRenderer, designationManager, unlockedProtosDb, protosDb.GetOrThrow<TerrainDesignationProto>(IdsCore.TerrainDesignators.DumpingDesignator), cameraController, oceanOverlayRenderer, builder, builder.AudioDb.GetSharedAudioUi("Assets/Unity/UserInterface/Audio/DumpApply.prefab"), (Option<Proto>) Option.None, false, false);
    }
    ...
    protected override void RegisterUiToolbar(
      ...
      ToolbarController toolbarController)
    {
      toolbarController.AddMainMenuButton(Tr.Designation__Dumping.TranslatedString, (IToolbarItemController) this, "Assets/Unity/UserInterface/Toolbar/Dumping.svg", 320f, (Func<ShortcutsManager, KeyBindings>) (m => m.ToggleDumpingTool));
    }
  }
}
