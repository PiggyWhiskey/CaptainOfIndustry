...
// Type: Mafi.Unity.Vehicles.TreePlanterMbFactory
...
namespace Mafi.Unity.Vehicles
{
  ...
  internal class TreePlanterMbFactory : 
    IEntityMbFactory<TreePlanter>,
    IFactory<TreePlanter, EntityMb>
  {
    ...
    public EntityMb Create(TreePlanter planter)
    {
      TreePlanterMb treePlanterMb = this.m_modelFactory.Create((DynamicGroundEntityProto) planter.Prototype).AddComponent<TreePlanterMb>();
      treePlanterMb.Initialize(planter, this.m_assetsDb, this.m_weatherManager, this.m_randomProvider, this.m_audioManager, this.m_dependencies);
      return (EntityMb) treePlanterMb;
    }
  }
}
