...
// Type: Mafi.Unity.UiToolkit.Library.ButtonColumn
...
{
  public class ButtonColumn : Button, IFlexComponent, IUiComponent
  {
    Option<IGapHandler> IFlexComponent.GapHandler { get; set; }

    public ButtonColumn(Action onClick = null, Outer outer = null, Inner inner = null)
    {
      xxhJUtQyC9HnIshc6H.OukgcisAbr();
      // ISSUE: explicit constructor call
      base.\u002Ector(onClick, outer, inner);
      this.Class<ButtonColumn>(Cls.column);
    }
